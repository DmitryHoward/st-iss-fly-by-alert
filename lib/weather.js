...
module.exports = {
  ...
  /**
   * Returns an Object containing correctly formatted coordinates from provided weather data.
   * @param {Object} JSON object returned from weather API
   * @returns {Object} the longitude and latitude of the input zipCode.
   */
  parseCoordinates: function (weatherData) {
    return {
